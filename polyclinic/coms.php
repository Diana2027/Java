                ...
                <nav class="uk-navbar" uk-navbar="{&quot;align&quot;:&quot;center&quot;,&quot;boundary&quot;:&quot;!.uk-navbar-container&quot;,&quot;dropbar&quot;:true,&quot;dropbar-anchor&quot;:&quot;!.uk-navbar-container&quot;,&quot;dropbar-mode&quot;:&quot;slide&quot;}">
                    ...
                    <div class="uk-navbar-right">
                        <ul class="uk-navbar-nav">
                            ...
                            <li><a href="http://localhost/polyclinic/index1.php">О компании</a></li>
                            <li class="uk-active uk-parent"><a class="" tabindex="0" aria-expanded="false" href="http://localhost/polyclinic/coms.php">Контакты</a></li>
            ...
            <div class="">
                <div class="uk-container"><div class="uk-grid-margin uk-grid uk-grid-stack" uk-grid="">
                        <div class="uk-flex-auto uk-width-1-1@m uk-first-column">
                            <h1 class="uk-margin-small">Контакты компании</h1>
                            <hr class="uk-divider-small">
                            <div class="uk-h6 uk-text-primary uk-margin-small">Краткая информация по местоположению компании, связи с ней и время работы</div>
                        </div>
                    </div>
                                        ...
                                        <li class="el-item">
                                            <div class="uk-grid-small uk-child-width-expand uk-flex-nowrap uk-grid" uk-grid="">
                                                ...
                                                <div class="el-content uk-panel">
                                                    <p><span><a class="el-content uk-link-text phone-click" href="tel:8806667776">Номер телефона: 8-800-666-77-76</a></span></p>
                                                </div>
                                            </div>
                                        </li>
                                        <li class="el-item">
                                            <div class="uk-grid-small uk-child-width-expand uk-flex-nowrap uk-grid" uk-grid="">
                                                ...
                                                <div class="el-content uk-panel">
                                                    <p><span><a class="el-content uk-link-text" href="mailto:babochkapink@gmail.com">Почта: babochkapink@gmail.com</a></span></p>
                                                </div>
                                            </div>
                                        </li>
                                        <li class="el-item">
                                            <div class="uk-grid-small uk-child-width-expand uk-flex-nowrap uk-grid" uk-grid="">
                                                ...
                                                <div><div class="el-content uk-panel">Где мы находимся:<br>Тверская область, город Ступино, ул. бульвар Чехова, д. 76, оф. 2</div></div>
                                            </div>
                                        </li>
                                        <li class="el-item">
                                            <div class="uk-grid-small uk-child-width-expand uk-flex-nowrap uk-grid" uk-grid="">
                                                ...
                                                <div><div class="el-content uk-panel">Когда мы работаем:<br>С понедельника по пятницу с 9:00 до 23:00<br>С субботы по воскресенье с 12:00 до 18:00</div></div>
                                            </div>
                                        </li>
                                    </ul>
                                </div>
